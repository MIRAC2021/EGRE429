...
proc create_ipi_design { offsetfile design_name } {
	...
	set pwm_0 [ create_bd_cell -type ip -vlnv vcu.edu:user:pwm:1.0 pwm_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores vcu.edu:user:pwm:1.0]]]]
