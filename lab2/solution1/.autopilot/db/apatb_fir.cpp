...
#define AUTOTB_TVOUT_data_in "../tv/cdatafile/c.fir.autotvout_data_in.dat"
...
extern "C"
void apatb_fir_hw(void* __xlx_apatb_param_data_out, hls::sim::Byte<2> __xlx_apatb_param_data_in)
{
  ...
  port0.param = __xlx_apatb_param_data_out;
  ...
  port1.param = &__xlx_apatb_param_data_in;
  ...
  try {
    ...
    fir_hw_stub_wrapper(__xlx_apatb_param_data_out, __xlx_apatb_param_data_in);
