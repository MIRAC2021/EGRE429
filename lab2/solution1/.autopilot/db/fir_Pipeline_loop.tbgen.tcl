...
set C_modelArgList {
	{ sext_ln12 int 22 regular  }
	{ acc_2_out int 31 regular {pointer 1}  }
	{ shift_reg int 16 regular {array 128 { 0 1 } 1 1 } {global 2}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln12", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln12 sc_in sc_lv 22 signal 0 } 
	...
	{ shift_reg_address1 sc_out sc_lv 7 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln12", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "sext_ln12", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_12s_16s_34s_34_4_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln12 { ap_none {  { sext_ln12 in_data 0 22 } } }
	acc_2_out { ap_vld {  { acc_2_out out_data 1 31 }  { acc_2_out_ap_vld out_vld 1 1 } } }
	shift_reg { ap_memory {  { shift_reg_address0 mem_address 1 7 }  { shift_reg_ce0 mem_ce 1 1 }  { shift_reg_we0 mem_we 1 1 }  { shift_reg_d0 mem_din 1 16 }  { shift_reg_address1 MemPortADDR2 1 7 }  { shift_reg_ce1 MemPortCE2 1 1 }  { shift_reg_q1 in_data 0 16 } } }
}
