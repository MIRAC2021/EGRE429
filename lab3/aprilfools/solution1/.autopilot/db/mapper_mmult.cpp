...
using hls::sim::Byte;
extern "C" void mmult(Byte<4>*, int);
extern "C" void apatb_mmult_hw(volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  mmult(__xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_output_r);
